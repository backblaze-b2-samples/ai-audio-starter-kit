...
The audio Library is the primary surface of this sample kit; these helpers
sit alongside `b2_client.py` so the generic explorer keeps its independent
listing / head / delete helpers while the audio path can grow extra
